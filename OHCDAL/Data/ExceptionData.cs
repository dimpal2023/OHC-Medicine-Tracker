       ...
       /* public static Int32 ExceptionAdd(ExceptionModel model)
        ...
        public static Int32 LogToDatabase(Exception ex, String Class, String Method)
        {
            ...
            try
            {
                ...
                myInt = SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.StoredProcedure, "dbo.OHC_ExceptionsInsert", parameters);
                return myInt;
            }
            catch (Exception ex1)
            {
        ...
        public DataSet GetExceptionData()
        {
            ...
            try
            {
                myDataSet = SqlHelper.ExecuteDataset(ConnectionString, CommandType.StoredProcedure, "dbo.GetExceptionData", parameters);
                return myDataSet;
            }
            catch (Exception ex)
            {
                ApplicationLogger.LogError(ex, "ExceptionData", "GetExceptionData");
                return null;
            }
            finally
            {
